 ...
 * @author Jason
 */
@WebServlet("/manager/DeviceSearch")
public class DeviceSearch extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/manager/staff_device.jsp").forward(request, response);
    }
